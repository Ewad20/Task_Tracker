...
const iconPaths = {
  ...
  myTasks:
    "M8 5h11v4H8V5Zm0 6h11v4H8v-4Zm0 6h11v2H8v-2ZM4 6.5l1 1 2-2M4 12.5l1 1 2-2M4 18.5l1 1 2-2",
  ...
  settings:
    "M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0-5v3m0 12v3M4.2 4.2l2.1 2.1m11.4 11.4 2.1 2.1M3 12h3m12 0h3M4.2 19.8l2.1-2.1M17.7 6.3l2.1-2.1",
    ...
    const loadProjects = async () => {
      ...
      try {
        ...
        setSelectedProjectId((currentProjectId) => {
          if (
            currentProjectId &&
            data.some((project) => project.id === currentProjectId)
          ) {
